...
namespace DDDToolkit.Examples.Shipping.Domain.Shipments;
...
{
    public Shipment(ShipmentId id, OrderId order, string destination, DateTimeOffset confirmedAt) : base(id)
    {
        Order = order;
    ...
    /// <summary>When the order was confirmed, not when this row was written. The envelope carries both.</summary>
